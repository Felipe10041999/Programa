...
export const routes: Routes = [
    ...
    {
      path: 'best',
      loadComponent: () => import('./components/principal/usuarios/best/best')
      .then(m=>m.Best),
      canActivate: [AuthGuard]
    },
    {
      path: 'best-registrar',
      loadComponent: () => import('./components/principal/usuarios/best/registrar-best/registrar-best')
      .then(m=>m.RegistrarBest),
      canActivate: [AuthGuard]
    },
    {
      path: 'best-editar/:id',
      loadComponent: () => import('./components/principal/usuarios/best/editar-best/editar-best')
      .then(m=>m.EditarBest),
      canActivate: [AuthGuard]
    },
